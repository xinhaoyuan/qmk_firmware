...
#    else // no inertia
    ...
    if (code == KC_MS_UP && mousekey_y_dir >= 0) {
        mousekey_y_dir = -1;
        mousekey_repeat_x = 0;
        mousekey_repeat_y = 0;
        mouse_report.x = move_unit(mousekey_repeat_x) * mousekey_x_dir;
        mouse_report.y = move_unit(mousekey_repeat_y) * mousekey_y_dir;
    } else if (code == KC_MS_DOWN && mousekey_y_dir <= 0) {
        mousekey_y_dir = 1;
        mousekey_repeat_x = 0;
        mousekey_repeat_y = 0;
        mouse_report.x = move_unit(mousekey_repeat_x) * mousekey_x_dir;
        mouse_report.y = move_unit(mousekey_repeat_y) * mousekey_y_dir;
    } else if (code == KC_MS_LEFT && mousekey_x_dir >= 0) {
        mousekey_x_dir = -1;
        mousekey_repeat_x = 0;
        mousekey_repeat_y = 0;
        mouse_report.x = move_unit(mousekey_repeat_x) * mousekey_x_dir;
        mouse_report.y = move_unit(mousekey_repeat_y) * mousekey_y_dir;
    } else if (code == KC_MS_RIGHT && mousekey_x_dir <= 0) {
        mousekey_x_dir = 1;
        mousekey_repeat_x = 0;
        mousekey_repeat_y = 0;
        mouse_report.x = move_unit(mousekey_repeat_x) * mousekey_x_dir;
