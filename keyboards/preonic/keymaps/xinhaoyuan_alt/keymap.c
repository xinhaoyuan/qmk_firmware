...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_LOWER] = LAYOUT_preonic_grid(
        ...
        _______, KC_GRV,  KC_BTN3, KC_BTN2, KC_BTN1, KC_LBRC, KC_MINS, KC_BTN1, KC_BTN2, KC_BTN3, KC_BSLS, _______,
    ...
    [L_RAISE] = LAYOUT_preonic_grid(
        ...
        _______, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO,   KC_NO,   KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_NO,
        _______, KC_GRV,  KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_NO,   KC_MINS, KC_RBRC, KC_NO,   KC_BSLS, _______,
        _______, KC_NO,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
        ),
