...
#define _LAYOUT LAYOUT_split_3x6_3
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_RAISE] = _LAYOUT(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_BTN1, KC_HOME, KC_UP,   KC_END,  KC_PGUP, KC_DEL,
        _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_RSFT, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______,
    ...
    [L_PARA] = _LAYOUT(
        ...
        _______, RM_VALU, RM_TOGG, KC_NO,   KC_MUTE, LPTOGG,  LPTOGG,  KC_MUTE, KC_NO,   RM_TOGG, RM_VALU, _______,
                                   _______, _______, KC_NO,   KC_NO,   _______, _______
    ),
};
