...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [L_BASE] = LAYOUT_split_3x6_3(
        KC_LGUI, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_RCTL,
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RALT,
                                   KC_LALT, LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_RSFT
    ),

    [L_LOWER] = LAYOUT_split_3x6_3(
        _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______,
        _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______,
        _______, KC_GRV,  KC_LBRC, KC_RBRC, KC_ESC,  KC_TAB,  CW_TOGG, KC_QUOT, KC_MINS, KC_EQL,  KC_BSLS, _______,
                                   _______, _______, KC_SPC,  KC_ENT,  _______, _______
    ),

    [L_RAISE] = LAYOUT_split_3x6_3(
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_INS,  KC_HOME, KC_UP,   KC_END,  KC_PGUP, _______,
        _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_DEL,  KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______,
        _______, KC_TILD, KC_LCBR, KC_RCBR, KC_F11,  KC_F12,  KC_BSPC, KC_DQT,  KC_UNDS, KC_PLUS, KC_PIPE, _______,
                                   _______, _______, KC_SPC,  KC_ENT,  _______, _______
    ),

    [L_MOUSE] = LAYOUT_split_3x6_3(
        _______, KC_WH_U, KC_WH_L, KC_MS_U, KC_WH_R, KC_NO,   KC_NO,   KC_WH_L, KC_MS_U, KC_WH_R, KC_WH_U, _______,
    ...
    [L_P_MOUSE] = LAYOUT_split_3x6_3(
        _______, KC_WH_U, KC_WH_L, KC_MS_U, KC_WH_R, KC_NO,   KC_NO,   KC_WH_L, KC_MS_U, KC_WH_R, KC_WH_U, _______,
        _______, KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, KC_NO,   KC_NO,   KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, _______,
        _______, LPSWCH,  KC_BTN3, KC_BTN2, KC_BTN1, KC_NO,   KC_NO,   KC_BTN1, KC_BTN2, KC_BTN3, LPSWCH,  _______,
                                   LPTOGG,  _______, KC_NO,   KC_NO,   _______, LPTOGG
    ),

    [L_P_ARROW] = LAYOUT_split_3x6_3(
        _______, KC_PGUP, KC_HOME, KC_UP,   KC_END,  KC_NO,   KC_NO,   KC_HOME, KC_UP,   KC_END,  KC_PGUP, _______,
        _______, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO,   KC_NO,   KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______,
        _______, LPSWCH,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   LPSWCH,  _______,
                                   LPTOGG,  _______, KC_NO,   KC_NO,   _______, LPTOGG
    ),

    [L_PARA] = LAYOUT_split_3x6_3(
        _______, RGB_HUI, RGB_SAI, RGB_VAI, KC_NO,   KC_VOLU, LPTOGG,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   _______,
        _______, RGB_HUD, RGB_SAD, RGB_VAD, KC_NO,   KC_VOLD, LPSWCH,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   _______,
        _______, RGB_TOG, RGB_M_P, KC_NO,   QK_BOOT, KC_MUTE, CW_TOGG, AMTOGG,  KC_NO,   KC_NO,   KC_NO,   _______,
                                   _______, _______, KC_NO,   KC_NO,   _______, _______
    ),
};
