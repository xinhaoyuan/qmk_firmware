...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_BASE] = LAYOUT_planck_grid(
        ...
        RAISE,   KC_ESC,  KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_RALT, KC_RCTL, KC_ESC,  LOWER
    ),

    [L_LOWER] = LAYOUT_planck_grid(
        KC_ESC,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL,
        OS_LCTL, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_RGUI,
        OS_LSFT, KC_GRV,  KC_LBRC, KC_RBRC, KC_MINS, KC_EQL,  KC_NO,   KC_QUOT, KC_MINS, KC_EQL,  KC_BSLS, OS_RSFT,
        _______, KC_NO,   OS_LGUI, OS_LALT, _______, KC_SPC,  KC_ENT,  _______, OS_RALT, OS_RCTL, KC_NO,   _______
    ),
