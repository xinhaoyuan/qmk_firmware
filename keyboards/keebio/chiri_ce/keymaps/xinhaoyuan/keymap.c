...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_LOWER] = _LAYOUT(
        ...
        _______, KC_GRV,  KC_LBRC, KC_RBRC, CW_TOGG, MY_LGUI, _______, _______, KC_NO,   KC_QUOT, KC_MINS, KC_EQL,  KC_BSLS, _______,
    ...
    [L_PARA] = _LAYOUT(
        ...
        _______, UG_TOGG, RGB_M_P, UG_NEXT, KC_CAPS, KC_MUTE, _______, _______, KC_NO,   AMTOGG,  KC_NO,   KC_NO,   KC_NO,   _______,
                                            _______, _______, KC_NO,   KC_NO,   _______, _______
    ),
};
